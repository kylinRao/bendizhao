...
class RegisterAccount(souhuNewsBase.souhuNewsBase):
    ...
    def setUp(self):
        ...
        self.driver = webdriver.Remote('http://127.0.0.1:6723/wd/hub', desired_caps)
    ...
    def test_01_register(self):
        ...
        self.shareNews2WX(inviteCode=self.inviteCode)
    ...
    def tearDown(self):
        ...
        # except:
        #     loggerInner.info("=======================================releasePhone error=============================")
        # 保存该用户状态信息
        # self.au.saveAccount()

        # exeSql(self.phoneNum)
